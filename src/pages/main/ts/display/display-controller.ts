...
export class DisplayController {
  ...
  private static addPyramidContent(): void {
    document.getElementById("graph")!.innerHTML =
      `<div id="pyramid"><svg id="pyramid-side-one" class="pyramid-side" viewBox="0 0 70 78.262"><polygon points="35,0 70,78.262 0,78.262" /></svg><svg id="pyramid-side-two" class="pyramid-side" viewBox="0 0 70 78.262"><polygon points="35,0 70,78.262 0,78.262" /></svg><svg id="pyramid-side-three" class="pyramid-side" viewBox="0 0 70 78.262"><polygon points="35,0 70,78.262 0,78.262" /></svg><svg id="pyramid-side-four" class="pyramid-side" viewBox="0 0 70 78.262"><polygon points="35,0 70,78.262 0,78.262" /></svg></div><div id="transform-pyramid" class="paused"><svg id="transform-pyramid-side-one" class="transform-pyramid-side" viewBox="0 0 70 78.262"><polygon points="35,0 70,78.262 0,78.262" /></svg><svg id="transform-pyramid-side-two" class="transform-pyramid-side" viewBox="0 0 70 78.262"><polygon points="35,0 70,78.262 0,78.262" /></svg><svg id="transform-pyramid-side-three" class="transform-pyramid-side" viewBox="0 0 70 78.262"><polygon points="35,0 70,78.262 0,78.262" /></svg><svg id="transform-pyramid-side-four" class="transform-pyramid-side" viewBox="0 0 70 78.262"><polygon points="35,0 70,78.262 0,78.262" /></svg></div><div id="axes"><div id="x-axis" class="axis"><div class="face face-front"></div><div class="face face-back"></div><div class="face face-left"></div><div class="face face-right"></div><div class="face face-top"></div><div class="face face-bottom"></div></div><div id="y-axis" class="axis"><div class="face face-front"></div><div class="face face-back"></div><div class="face face-left"></div><div class="face face-right"></div><div class="face face-top"></div><div class="face face-bottom"></div></div><div id="z-axis" class="axis"><div class="face face-front"></div><div class="face face-back"></div><div class="face face-left"></div><div class="face face-right"></div><div class="face face-top"></div><div class="face face-bottom"></div></div></div>`;
    this.addAxisDirection(3);
  }
